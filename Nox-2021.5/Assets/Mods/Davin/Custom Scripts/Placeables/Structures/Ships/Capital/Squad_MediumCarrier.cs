...
{
    public class Squad_MediumCarrier : MediumCarrier
    {
        ...
        public override void setDefaults()
        {
            ...
            addDefaultSocket("ShieldPods/MassiveShieldPod", "ShieldPod1", new Vector2(-19.97f, 38.47f));
            addDefaultSocket("ShieldPods/MassiveShieldPod", "ShieldPod2", new Vector2(19.97f, 38.47f));
