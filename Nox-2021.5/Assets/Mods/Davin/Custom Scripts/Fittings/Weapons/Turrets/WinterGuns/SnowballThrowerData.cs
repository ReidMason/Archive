...
{
    [CreateAssetMenu(fileName = "SnowballThrowerData", menuName = "ScriptableObjects/Fittings/Weapons/SnowballThrowerData")]
    public class SnowballThrowerData : RotatingTurretData, ISnowballThrowerData
    {
