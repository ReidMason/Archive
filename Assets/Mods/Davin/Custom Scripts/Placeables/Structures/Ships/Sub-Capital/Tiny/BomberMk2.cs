...
namespace Davin.Placeables.Ships
{
    public class BomberMk2 : Bomber
    {
        ...
        public override void setDefaults()
        {
            ...
            addDefaultSocket("EngineBays/TinyEngineBay", "Engine", new Vector2(0f, -9.36f));

            addDefaultSocket("WeaponBays/TinyLauncher", "BombBay", new Vector2(0f, 2.61f));
        }
        */
